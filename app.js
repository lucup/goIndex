...
// 在head 中 加载 必要静态
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/lucup/goIndex/css/mdui.min.css">'
);
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/lucup/goIndex/css/nexmoe.min.css">'
);
// markdown支持
document.write(
  '<script src="//cdn.jsdelivr.net/gh/lucup/goIndex/js/markdown-it.min.js"></script>'
);
document.write(
...
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/lucup/goIndex/css/DPlayer.min.css">'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/lucup/goIndex/js/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/lucup/goIndex/js/hls.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/lucup/goIndex/js/flv.min.js"></script>'
);
	  ...
	  <ul class="mdui-list"> 
	   <li class="mdui-list-item th"> 
	    ...
	    <div class="mdui-col-sm-3 mdui-text-right">
	     时间 <i class="mdui-icon material-icons icon-sort" data-sort="date" data-order="downward">expand_more</i>
	    </div> 
